...
(RETURN TYPE) (CLASS)::(FUNCTION NAME) {
    ...
    //output basic information/logic of test;
    //for example (in order):
    //1) testing an overloaded ostream function that returns 
    //an ansi escape code as a string in the output
    //2) where that should equal? should be? 
    //3) a ansi escape character string you're testing against

    //check the content of the stringstream object 
    //to see if it's equal to the ansi escape code.
    //the ansi escape code should correlate to the 
    //string from the overloaded ostream function output

    //if true, output success indicator and increment success count
    //else, output failure indicator and increment failure count
}
*/
...
void Test_FGColours816::TEST_FG_BOLDLIGHTMAGENTA() {
    ...
    std::cout << termstylist::FG_LightYellow << "termstylist::FG_BoldLightMagenta " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[95;1m " << termstylist::FG_White << this->endBreak;
...
//test: bg bold light grey 
void Test_BGColours816::TEST_BG_BOLDLIGHTGREY() {
    std::ostringstream BG__BOLDLIGHTGREY;

    BG__BOLDLIGHTGREY << termstylist::BG_BoldLightGrey;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG_BoldLightGrey " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[47;1m " << termstylist::FG_White << this->endBreak;

    if(BG__BOLDLIGHTGREY.str() == "\033[47;1m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 51
void Test_BGColours256::TEST_BG256_51() {
    std::ostringstream BG256__51;

    BG256__51 << termstylist::BG256_51;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_51 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;51m " << termstylist::FG_White << this->endBreak;

    if(BG256__51.str() == "\033[48;5;51m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 52
void Test_BGColours256::TEST_BG256_52() {
    std::ostringstream BG256__52;

    BG256__52 << termstylist::BG256_52;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_52 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;52m " << termstylist::FG_White << this->endBreak;

    if(BG256__52.str() == "\033[48;5;52m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 53
void Test_BGColours256::TEST_BG256_53() {
    std::ostringstream BG256__53;

    BG256__53 << termstylist::BG256_53;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_53 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;53m " << termstylist::FG_White << this->endBreak;

    if(BG256__53.str() == "\033[48;5;53m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 54
void Test_BGColours256::TEST_BG256_54() {
    std::ostringstream BG256__54;

    BG256__54 << termstylist::BG256_54;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_54 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;54m " << termstylist::FG_White << this->endBreak;

    if(BG256__54.str() == "\033[48;5;54m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 55
void Test_BGColours256::TEST_BG256_55() {
    std::ostringstream BG256__55;

    BG256__55 << termstylist::BG256_55;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_55 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;55m " << termstylist::FG_White << this->endBreak;

    if(BG256__55.str() == "\033[48;5;55m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 56
void Test_BGColours256::TEST_BG256_56() {
    std::ostringstream BG256__56;

    BG256__56 << termstylist::BG256_56;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_56 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;56m " << termstylist::FG_White << this->endBreak;

    if(BG256__56.str() == "\033[48;5;56m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 57
void Test_BGColours256::TEST_BG256_57() {
    std::ostringstream BG256__57;

    BG256__57 << termstylist::BG256_57;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_57 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;57m " << termstylist::FG_White << this->endBreak;

    if(BG256__57.str() == "\033[48;5;57m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 58
void Test_BGColours256::TEST_BG256_58() {
    std::ostringstream BG256__58;

    BG256__58 << termstylist::BG256_58;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_58 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;58m " << termstylist::FG_White << this->endBreak;

    if(BG256__58.str() == "\033[48;5;58m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 59
void Test_BGColours256::TEST_BG256_59() {
    std::ostringstream BG256__59;

    BG256__59 << termstylist::BG256_59;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_59 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;59m " << termstylist::FG_White << this->endBreak;

    if(BG256__59.str() == "\033[48;5;59m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 60
void Test_BGColours256::TEST_BG256_60() {
    std::ostringstream BG256__60;

    BG256__60 << termstylist::BG256_60;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_60 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;60m " << termstylist::FG_White << this->endBreak;

    if(BG256__60.str() == "\033[48;5;60m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 61
void Test_BGColours256::TEST_BG256_61() {
    std::ostringstream BG256__61;

    BG256__61 << termstylist::BG256_61;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_61 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;61m " << termstylist::FG_White << this->endBreak;

    if(BG256__61.str() == "\033[48;5;61m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 62
void Test_BGColours256::TEST_BG256_62() {
    std::ostringstream BG256__62;

    BG256__62 << termstylist::BG256_62;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_62 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;62m " << termstylist::FG_White << this->endBreak;

    if(BG256__62.str() == "\033[48;5;62m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 63
void Test_BGColours256::TEST_BG256_63() {
    std::ostringstream BG256__63;

    BG256__63 << termstylist::BG256_63;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_63 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;63m " << termstylist::FG_White << this->endBreak;

    if(BG256__63.str() == "\033[48;5;63m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 64
void Test_BGColours256::TEST_BG256_64() {
    std::ostringstream BG256__64;

    BG256__64 << termstylist::BG256_64;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_64 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;64m " << termstylist::FG_White << this->endBreak;

    if(BG256__64.str() == "\033[48;5;64m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 65
void Test_BGColours256::TEST_BG256_65() {
    std::ostringstream BG256__65;

    BG256__65 << termstylist::BG256_65;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_65 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;65m " << termstylist::FG_White << this->endBreak;

    if(BG256__65.str() == "\033[48;5;65m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 66
void Test_BGColours256::TEST_BG256_66() {
    std::ostringstream BG256__66;

    BG256__66 << termstylist::BG256_66;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_66 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;66m " << termstylist::FG_White << this->endBreak;

    if(BG256__66.str() == "\033[48;5;66m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 67
void Test_BGColours256::TEST_BG256_67() {
    std::ostringstream BG256__67;

    BG256__67 << termstylist::BG256_67;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_67 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;67m " << termstylist::FG_White << this->endBreak;

    if(BG256__67.str() == "\033[48;5;67m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 68
void Test_BGColours256::TEST_BG256_68() {
    std::ostringstream BG256__68;

    BG256__68 << termstylist::BG256_68;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_68 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;68m " << termstylist::FG_White << this->endBreak;

    if(BG256__68.str() == "\033[48;5;68m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 69
void Test_BGColours256::TEST_BG256_69() {
    std::ostringstream BG256__69;

    BG256__69 << termstylist::BG256_69;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_69 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;69m " << termstylist::FG_White << this->endBreak;

    if(BG256__69.str() == "\033[48;5;69m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 70
void Test_BGColours256::TEST_BG256_70() {
    std::ostringstream BG256__70;

    BG256__70 << termstylist::BG256_70;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_70 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;70m " << termstylist::FG_White << this->endBreak;

    if(BG256__70.str() == "\033[48;5;70m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 71
void Test_BGColours256::TEST_BG256_71() {
    std::ostringstream BG256__71;

    BG256__71 << termstylist::BG256_71;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_71 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;71m " << termstylist::FG_White << this->endBreak;

    if(BG256__71.str() == "\033[48;5;71m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 72
void Test_BGColours256::TEST_BG256_72() {
    std::ostringstream BG256__72;

    BG256__72 << termstylist::BG256_72;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_72 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;72m " << termstylist::FG_White << this->endBreak;

    if(BG256__72.str() == "\033[48;5;72m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 73
void Test_BGColours256::TEST_BG256_73() {
    std::ostringstream BG256__73;

    BG256__73 << termstylist::BG256_73;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_73 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;73m " << termstylist::FG_White << this->endBreak;

    if(BG256__73.str() == "\033[48;5;73m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 74
void Test_BGColours256::TEST_BG256_74() {
    std::ostringstream BG256__74;

    BG256__74 << termstylist::BG256_74;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_74 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;74m " << termstylist::FG_White << this->endBreak;

    if(BG256__74.str() == "\033[48;5;74m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 75
void Test_BGColours256::TEST_BG256_75() {
    std::ostringstream BG256__75;

    BG256__75 << termstylist::BG256_75;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_75 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;75m " << termstylist::FG_White << this->endBreak;

    if(BG256__75.str() == "\033[48;5;75m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 76
void Test_BGColours256::TEST_BG256_76() {
    std::ostringstream BG256__76;

    BG256__76 << termstylist::BG256_76;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_76 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;76m " << termstylist::FG_White << this->endBreak;

    if(BG256__76.str() == "\033[48;5;76m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 77
void Test_BGColours256::TEST_BG256_77() {
    std::ostringstream BG256__77;

    BG256__77 << termstylist::BG256_77;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_77 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;77m " << termstylist::FG_White << this->endBreak;

    if(BG256__77.str() == "\033[48;5;77m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 78
void Test_BGColours256::TEST_BG256_78() {
    std::ostringstream BG256__78;

    BG256__78 << termstylist::BG256_78;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_78 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;78m " << termstylist::FG_White << this->endBreak;

    if(BG256__78.str() == "\033[48;5;78m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 79
void Test_BGColours256::TEST_BG256_79() {
    std::ostringstream BG256__79;

    BG256__79 << termstylist::BG256_79;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_79 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;79m " << termstylist::FG_White << this->endBreak;

    if(BG256__79.str() == "\033[48;5;79m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 80
void Test_BGColours256::TEST_BG256_80() {
    std::ostringstream BG256__80;

    BG256__80 << termstylist::BG256_80;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_80 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;80m " << termstylist::FG_White << this->endBreak;

    if(BG256__80.str() == "\033[48;5;80m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 81
void Test_BGColours256::TEST_BG256_81() {
    std::ostringstream BG256__81;

    BG256__81 << termstylist::BG256_81;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_81 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;81m " << termstylist::FG_White << this->endBreak;

    if(BG256__81.str() == "\033[48;5;81m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 82
void Test_BGColours256::TEST_BG256_82() {
    std::ostringstream BG256__82;

    BG256__82 << termstylist::BG256_82;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_82 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;82m " << termstylist::FG_White << this->endBreak;

    if(BG256__82.str() == "\033[48;5;82m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 83
void Test_BGColours256::TEST_BG256_83() {
    std::ostringstream BG256__83;

    BG256__83 << termstylist::BG256_83;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_83 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;83m " << termstylist::FG_White << this->endBreak;

    if(BG256__83.str() == "\033[48;5;83m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 84
void Test_BGColours256::TEST_BG256_84() {
    std::ostringstream BG256__84;

    BG256__84 << termstylist::BG256_84;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_84 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;84m " << termstylist::FG_White << this->endBreak;

    if(BG256__84.str() == "\033[48;5;84m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 85
void Test_BGColours256::TEST_BG256_85() {
    std::ostringstream BG256__85;

    BG256__85 << termstylist::BG256_85;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_85 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;85m " << termstylist::FG_White << this->endBreak;

    if(BG256__85.str() == "\033[48;5;85m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 86
void Test_BGColours256::TEST_BG256_86() {
    std::ostringstream BG256__86;

    BG256__86 << termstylist::BG256_86;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_86 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;86m " << termstylist::FG_White << this->endBreak;

    if(BG256__86.str() == "\033[48;5;86m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 87
void Test_BGColours256::TEST_BG256_87() {
    std::ostringstream BG256__87;

    BG256__87 << termstylist::BG256_87;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_87 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;87m " << termstylist::FG_White << this->endBreak;

    if(BG256__87.str() == "\033[48;5;87m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 88
void Test_BGColours256::TEST_BG256_88() {
    std::ostringstream BG256__88;

    BG256__88 << termstylist::BG256_88;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_88 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;88m " << termstylist::FG_White << this->endBreak;

    if(BG256__88.str() == "\033[48;5;88m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 89
void Test_BGColours256::TEST_BG256_89() {
    std::ostringstream BG256__89;

    BG256__89 << termstylist::BG256_89;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_89 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;89m " << termstylist::FG_White << this->endBreak;

    if(BG256__89.str() == "\033[48;5;89m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 90
void Test_BGColours256::TEST_BG256_90() {
    std::ostringstream BG256__90;

    BG256__90 << termstylist::BG256_90;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_90 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;90m " << termstylist::FG_White << this->endBreak;

    if(BG256__90.str() == "\033[48;5;90m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 91
void Test_BGColours256::TEST_BG256_91() {
    std::ostringstream BG256__91;

    BG256__91 << termstylist::BG256_91;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_91 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;91m " << termstylist::FG_White << this->endBreak;

    if(BG256__91.str() == "\033[48;5;91m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 92
void Test_BGColours256::TEST_BG256_92() {
    std::ostringstream BG256__92;

    BG256__92 << termstylist::BG256_92;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_92 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;92m " << termstylist::FG_White << this->endBreak;

    if(BG256__92.str() == "\033[48;5;92m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 93
void Test_BGColours256::TEST_BG256_93() {
    std::ostringstream BG256__93;

    BG256__93 << termstylist::BG256_93;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_93 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;93m " << termstylist::FG_White << this->endBreak;

    if(BG256__93.str() == "\033[48;5;93m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 94
void Test_BGColours256::TEST_BG256_94() {
    std::ostringstream BG256__94;

    BG256__94 << termstylist::BG256_94;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_94 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;94m " << termstylist::FG_White << this->endBreak;

    if(BG256__94.str() == "\033[48;5;94m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 95
void Test_BGColours256::TEST_BG256_95() {
    std::ostringstream BG256__95;

    BG256__95 << termstylist::BG256_95;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_95 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;95m " << termstylist::FG_White << this->endBreak;

    if(BG256__95.str() == "\033[48;5;95m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 96
void Test_BGColours256::TEST_BG256_96() {
    std::ostringstream BG256__96;

    BG256__96 << termstylist::BG256_96;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_96 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;96m " << termstylist::FG_White << this->endBreak;

    if(BG256__96.str() == "\033[48;5;96m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 97
void Test_BGColours256::TEST_BG256_97() {
    std::ostringstream BG256__97;

    BG256__97 << termstylist::BG256_97;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_97 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;97m " << termstylist::FG_White << this->endBreak;

    if(BG256__97.str() == "\033[48;5;97m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 98
void Test_BGColours256::TEST_BG256_98() {
    std::ostringstream BG256__98;

    BG256__98 << termstylist::BG256_98;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_98 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;98m " << termstylist::FG_White << this->endBreak;

    if(BG256__98.str() == "\033[48;5;98m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 99
void Test_BGColours256::TEST_BG256_99() {
    std::ostringstream BG256__99;

    BG256__99 << termstylist::BG256_99;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_99 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;99m " << termstylist::FG_White << this->endBreak;

    if(BG256__99.str() == "\033[48;5;99m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 100
void Test_BGColours256::TEST_BG256_100() {
    std::ostringstream BG256__100;

    BG256__100 << termstylist::BG256_100;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_100 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;100m " << termstylist::FG_White << this->endBreak;

    if(BG256__100.str() == "\033[48;5;100m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 111
void Test_BGColours256::TEST_BG256_111() {
    std::ostringstream BG256__111;

    BG256__111 << termstylist::BG256_111;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_111 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;111m " << termstylist::FG_White << this->endBreak;

    if(BG256__111.str() == "\033[48;5;111m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 112
void Test_BGColours256::TEST_BG256_112() {
    std::ostringstream BG256__112;

    BG256__112 << termstylist::BG256_112;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_112 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;112m " << termstylist::FG_White << this->endBreak;

    if(BG256__112.str() == "\033[48;5;112m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 113
void Test_BGColours256::TEST_BG256_113() {
    std::ostringstream BG256__113;

    BG256__113 << termstylist::BG256_113;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_113 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;113m " << termstylist::FG_White << this->endBreak;

    if(BG256__113.str() == "\033[48;5;113m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 114
void Test_BGColours256::TEST_BG256_114() {
    std::ostringstream BG256__114;

    BG256__114 << termstylist::BG256_114;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_114 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;114m " << termstylist::FG_White << this->endBreak;

    if(BG256__114.str() == "\033[48;5;114m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 115
void Test_BGColours256::TEST_BG256_115() {
    std::ostringstream BG256__115;

    BG256__115 << termstylist::BG256_115;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_115 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;115m " << termstylist::FG_White << this->endBreak;

    if(BG256__115.str() == "\033[48;5;115m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 116
void Test_BGColours256::TEST_BG256_116() {
    std::ostringstream BG256__116;

    BG256__116 << termstylist::BG256_116;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_116 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;116m " << termstylist::FG_White << this->endBreak;

    if(BG256__116.str() == "\033[48;5;116m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 117
void Test_BGColours256::TEST_BG256_117() {
    std::ostringstream BG256__117;

    BG256__117 << termstylist::BG256_117;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_117 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;117m " << termstylist::FG_White << this->endBreak;

    if(BG256__117.str() == "\033[48;5;117m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 118
void Test_BGColours256::TEST_BG256_118() {
    std::ostringstream BG256__118;

    BG256__118 << termstylist::BG256_118;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_118 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;118m " << termstylist::FG_White << this->endBreak;

    if(BG256__118.str() == "\033[48;5;118m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 119
void Test_BGColours256::TEST_BG256_119() {
    std::ostringstream BG256__119;

    BG256__119 << termstylist::BG256_119;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_119 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;119m " << termstylist::FG_White << this->endBreak;

    if(BG256__119.str() == "\033[48;5;119m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 120
void Test_BGColours256::TEST_BG256_120() {
    std::ostringstream BG256__120;

    BG256__120 << termstylist::BG256_120;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_120 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;120m " << termstylist::FG_White << this->endBreak;

    if(BG256__120.str() == "\033[48;5;120m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 121
void Test_BGColours256::TEST_BG256_121() {
    std::ostringstream BG256__121;

    BG256__121 << termstylist::BG256_121;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_121 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;121m " << termstylist::FG_White << this->endBreak;

    if(BG256__121.str() == "\033[48;5;121m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 122
void Test_BGColours256::TEST_BG256_122() {
    std::ostringstream BG256__122;

    BG256__122 << termstylist::BG256_122;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_122 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;122m " << termstylist::FG_White << this->endBreak;

    if(BG256__122.str() == "\033[48;5;122m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 123
void Test_BGColours256::TEST_BG256_123() {
    std::ostringstream BG256__123;

    BG256__123 << termstylist::BG256_123;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_123 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;123m " << termstylist::FG_White << this->endBreak;

    if(BG256__123.str() == "\033[48;5;123m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 124
void Test_BGColours256::TEST_BG256_124() {
    std::ostringstream BG256__124;

    BG256__124 << termstylist::BG256_124;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_124 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;124m " << termstylist::FG_White << this->endBreak;

    if(BG256__124.str() == "\033[48;5;124m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 125
void Test_BGColours256::TEST_BG256_125()  {
    std::ostringstream BG256__125;

    BG256__125 << termstylist::BG256_125;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_125 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;125m " << termstylist::FG_White << this->endBreak;

    if(BG256__125.str() == "\033[48;5;125m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 126
void Test_BGColours256::TEST_BG256_126() {
    std::ostringstream BG256__126;

    BG256__126 << termstylist::BG256_126;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_126 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;126m " << termstylist::FG_White << this->endBreak;

    if(BG256__126.str() == "\033[48;5;126m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 127
void Test_BGColours256::TEST_BG256_127() {
    std::ostringstream BG256__127;

    BG256__127 << termstylist::BG256_127;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_127 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;127m " << termstylist::FG_White << this->endBreak;

    if(BG256__127.str() == "\033[48;5;127m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 128
void Test_BGColours256::TEST_BG256_128() {
    std::ostringstream BG256__128;

    BG256__128 << termstylist::BG256_128;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_128 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;128m " << termstylist::FG_White << this->endBreak;

    if(BG256__128.str() == "\033[48;5;128m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 129
void Test_BGColours256::TEST_BG256_129() {
    std::ostringstream BG256__129;

    BG256__129 << termstylist::BG256_129;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_129 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;129m " << termstylist::FG_White <<  this->endBreak;

    if(BG256__129.str() == "\033[48;5;129m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 130
void Test_BGColours256::TEST_BG256_130() {
    std::ostringstream BG256__130;

    BG256__130 << termstylist::BG256_130;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_130 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;130m " << termstylist::FG_White << this->endBreak;

    if(BG256__130.str() == "\033[48;5;130m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 131
void Test_BGColours256::TEST_BG256_131() {
    std::ostringstream BG256__131;

    BG256__131 << termstylist::BG256_132;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_131 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;131m " << termstylist::FG_White << this->endBreak;

    if(BG256__131.str() == "\033[48;5;132m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 132
void Test_BGColours256::TEST_BG256_132() {
    std::ostringstream BG256__132;

    BG256__132 << termstylist::BG256_132;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_132 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;132m " << termstylist::FG_White << this->endBreak;

    if(BG256__132.str() == "\033[48;5;132m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 133
void Test_BGColours256::TEST_BG256_133() {
    std::ostringstream BG256__133;

    BG256__133 << termstylist::BG256_133;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_133 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;133m " << termstylist::FG_White << this->endBreak;

    if(BG256__133.str() == "\033[48;5;133m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 134
void Test_BGColours256::TEST_BG256_134() {
    std::ostringstream BG256__134;

    BG256__134 << termstylist::BG256_134;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_134 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;134m " << termstylist::FG_White << this->endBreak;

    if(BG256__134.str() == "\033[48;5;134m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 135
void Test_BGColours256::TEST_BG256_135() {
    std::ostringstream BG256__135;

    BG256__135 << termstylist::BG256_135;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_135 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;135m " << termstylist::FG_White << this->endBreak;

    if(BG256__135.str() == "\033[48;5;135m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 136
void Test_BGColours256::TEST_BG256_136() {
    std::ostringstream BG256__136;

    BG256__136 << termstylist::BG256_136;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_136 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;136m " << termstylist::FG_White << this->endBreak;

    if(BG256__136.str() == "\033[48;5;136m")  {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 137
void Test_BGColours256::TEST_BG256_137() {
    std::ostringstream BG256__137;

    BG256__137 << termstylist::BG256_137;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_137 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;137m " << termstylist::FG_White << this->endBreak;

    if(BG256__137.str() == "\033[48;5;137m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 138
void Test_BGColours256::TEST_BG256_138() {
    std::ostringstream BG256__138;

    BG256__138 << termstylist::BG256_138;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_138 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;138m " << termstylist::FG_White << this->endBreak;

    if(BG256__138.str() == "\033[48;5;138m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 139
void Test_BGColours256::TEST_BG256_139() {
    std::ostringstream BG256__139;

    BG256__139 << termstylist::BG256_139;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_139 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;139m " << termstylist::FG_White << this->endBreak;

    if(BG256__139.str() == "\033[48;5;139m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 140
void Test_BGColours256::TEST_BG256_140() {
    std::ostringstream BG256__140;

    BG256__140 << termstylist::BG256_140;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_140 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;140m " << termstylist::FG_White << this->endBreak;

    if(BG256__140.str() == "\033[48;5;140m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 141
void Test_BGColours256::TEST_BG256_141() {
    std::ostringstream BG256__141;

    BG256__141 << termstylist::BG256_141;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_141 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;141m " << termstylist::FG_White << this->endBreak;

    if(BG256__141.str() == "\033[48;5;141m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 142
void Test_BGColours256::TEST_BG256_142() {
    std::ostringstream BG256__142;

    BG256__142 << termstylist::BG256_142;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_142 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;142m " << termstylist::FG_White << this->endBreak;

    if(BG256__142.str() == "\033[48;5;142m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 143
void Test_BGColours256::TEST_BG256_143() {
    std::ostringstream BG256__143;

    BG256__143 << termstylist::BG256_143;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_143 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;143m " << termstylist::FG_White << this->endBreak;

    if(BG256__143.str() == "\033[48;5;143m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 144
void Test_BGColours256::TEST_BG256_144() {
    std::ostringstream BG256__144;

    BG256__144 << termstylist::BG256_144;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_144 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;144m " << termstylist::FG_White << this->endBreak;

    if(BG256__144.str() == "\033[48;5;144m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 145
void Test_BGColours256::TEST_BG256_145() {
    std::ostringstream BG256__145;

    BG256__145 << termstylist::BG256_145;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_145 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;145m " << termstylist::FG_White << this->endBreak;

    if(BG256__145.str() == "\033[48;5;145m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 146
void Test_BGColours256::TEST_BG256_146() {
    std::ostringstream BG256__146;

    BG256__146 << termstylist::BG256_146;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_146 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;146m " << termstylist::FG_White << this->endBreak;

    if(BG256__146.str() == "\033[48;5;146m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 147
void Test_BGColours256::TEST_BG256_147() {
    std::ostringstream BG256__147;

    BG256__147 << termstylist::BG256_147;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_147 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;147m " << termstylist::FG_White << this->endBreak;

    if(BG256__147.str() == "\033[48;5;147m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 148
void Test_BGColours256::TEST_BG256_148() {
    std::ostringstream BG256__148;

    BG256__148 << termstylist::BG256_148;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_148 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;148m " << termstylist::FG_White << this->endBreak;

    if(BG256__148.str() == "\033[48;5;148m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 149
void Test_BGColours256::TEST_BG256_149() {
    std::ostringstream BG256_149;

    BG256_149 << termstylist::BG256_149;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_149 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;149m " << termstylist::FG_White << this->endBreak;

    if(BG256_149.str() == "\033[48;5;149m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 150
void Test_BGColours256::TEST_BG256_150() {
    std::ostringstream BG256__150;

    BG256__150 << termstylist::BG256_150;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_150 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;150m " << termstylist::FG_White << this->endBreak;

    if(BG256__150.str() == "\033[48;5;150m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 151
void Test_BGColours256::TEST_BG256_151() {
    std::ostringstream BG256__151;

    BG256__151 << termstylist::BG256_151;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_151 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;151m " << termstylist::FG_White << this->endBreak;

    if(BG256__151.str() == "\033[48;5;151m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 152
void Test_BGColours256::TEST_BG256_152() {
    std::ostringstream BG256__152;

    BG256__152 << termstylist::BG256_152;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_152 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;152m " << termstylist::FG_White << this->endBreak;

    if(BG256__152.str() == "\033[48;5;152m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 153
void Test_BGColours256::TEST_BG256_153() {
    std::ostringstream BG256__153;

    BG256__153 << termstylist::BG256_153;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_153 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;153m " << termstylist::FG_White << this->endBreak;

    if(BG256__153.str() == "\033[48;5;153m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 154
void Test_BGColours256::TEST_BG256_154() {
    std::ostringstream BG256__154;

    BG256__154 << termstylist::BG256_154;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_154 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;154m " << termstylist::FG_White << this->endBreak;

    if(BG256__154.str() == "\033[48;5;154m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 155
void Test_BGColours256::TEST_BG256_155() {
    std::ostringstream BG256__155;

    BG256__155 << termstylist::BG256_155;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_155 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;155m " << termstylist::FG_White << this->endBreak;

    if(BG256__155.str() == "\033[48;5;155m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 156
void Test_BGColours256::TEST_BG256_156() {
    std::ostringstream BG256__156;

    BG256__156 << termstylist::BG256_156;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_156 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;156m " << termstylist::FG_White << this->endBreak;

    if(BG256__156.str() == "\033[48;5;156m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 157
void Test_BGColours256::TEST_BG256_157() {
    std::ostringstream BG256__157;

    BG256__157 << termstylist::BG256_157;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_157 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;157m " << termstylist::FG_White << this->endBreak;

    if(BG256__157.str() == "\033[48;5;157m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 158
void Test_BGColours256::TEST_BG256_158() {
    std::ostringstream BG256__158;

    BG256__158 << termstylist::BG256_158;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_158 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;158m " << termstylist::FG_White << this->endBreak;

    if(BG256__158.str() == "\033[48;5;158m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 159
void Test_BGColours256::TEST_BG256_159() {
    std::ostringstream BG256__159;

    BG256__159 << termstylist::BG256_159;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_159 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;159m " << termstylist::FG_White << this->endBreak;

    if(BG256__159.str() == "\033[48;5;159m") {
        std::cout << TEST_SUCCESS;
        countSuccess++; 
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 160
void Test_BGColours256::TEST_BG256_160() {
    std::ostringstream BG256__160;

    BG256__160 << termstylist::BG256_160;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_160 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;160m " << termstylist::FG_White << this->endBreak;

    if(BG256__160.str() == "\033[48;5;160m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 161
void Test_BGColours256::TEST_BG256_161() {
    std::ostringstream BG256__161;

    BG256__161 << termstylist::BG256_161;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_161 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;161m " << termstylist::FG_White << this->endBreak;

    if(BG256__161.str() == "\033[48;5;161m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 162
void Test_BGColours256::TEST_BG256_162() {
    std::ostringstream BG256__162;

    BG256__162 << termstylist::BG256_162;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_162 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;162m " << termstylist::FG_White << this->endBreak;

    if(BG256__162.str() == "\033[48;5;162m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 163
void Test_BGColours256::TEST_BG256_163() {
    std::ostringstream BG256__163;
    
    BG256__163 << termstylist::BG256_163;
    
    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_163 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;163m " << termstylist::FG_White << this->endBreak;

    if(BG256__163.str() == "\033[48;5;163m") {
        std::cout << TEST_SUCCESS;
        countSuccess++; 
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 164
void Test_BGColours256::TEST_BG256_164() {
    std::ostringstream BG256__164;

    BG256__164 << termstylist::BG256_164;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_164 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;164m " << termstylist::FG_White << this->endBreak;

    if(BG256__164.str() == "\033[48;5;164m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 165
void Test_BGColours256::TEST_BG256_165() {
    std::ostringstream BG256__165;

    BG256__165 << termstylist::BG256_165;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_165 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;165m " << termstylist::FG_White << this->endBreak;

    if(BG256__165.str() == "\033[48;5;165m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 166
void Test_BGColours256::TEST_BG256_166() {
    std::ostringstream BG256__166;

    BG256__166 << termstylist::BG256_166;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_166 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;166m " << termstylist::FG_White << this->endBreak;

    if(BG256__166.str() == "\033[48;5;166m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 167
void Test_BGColours256::TEST_BG256_167() {
    std::ostringstream BG256__167;

    BG256__167 << termstylist::BG256_167;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_167 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;167m " << termstylist::FG_White << this->endBreak;

    if(BG256__167.str() == "\033[48;5;167m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 168
void Test_BGColours256::TEST_BG256_168() {
    std::ostringstream BG256__168;

    BG256__168 << termstylist::BG256_168;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_168 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;168m " << termstylist::FG_White << this->endBreak;

    if(BG256__168.str() == "\033[48;5;168m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 169
void Test_BGColours256::TEST_BG256_169() {
    std::ostringstream BG256__169;

    BG256__169 << termstylist::BG256_169;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_169 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;169m " << termstylist::FG_White << this->endBreak;

    if(BG256__169.str() == "\033[48;5;169m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 170
void Test_BGColours256::TEST_BG256_170() {
    std::ostringstream BG256__170;

    BG256__170 << termstylist::BG256_170;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_170 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;170m " << termstylist::FG_White << this->endBreak;

    if(BG256__170.str() == "\033[48;5;170m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 171
void Test_BGColours256::TEST_BG256_171() {
    std::ostringstream BG256__171;

    BG256__171 << termstylist::BG256_171;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_171 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;171m " << termstylist::FG_White << this->endBreak;

    if(BG256__171.str() == "\033[48;5;171m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 172
void Test_BGColours256::TEST_BG256_172() {
    std::ostringstream BG256__172;

    BG256__172 << termstylist::BG256_172;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_172 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;172m " << termstylist::FG_White << this->endBreak;

    if(BG256__172.str() == "\033[48;5;172m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 173
void Test_BGColours256::TEST_BG256_173() {
    std::ostringstream BG256__173;

    BG256__173 << termstylist::BG256_173;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_173 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;173m " << termstylist::FG_White << this->endBreak;

    if(BG256__173.str() == "\033[48;5;173m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 174
void Test_BGColours256::TEST_BG256_174() {
    std::ostringstream BG256__174;

    BG256__174 << termstylist::BG256_174;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_174 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;174m " << termstylist::FG_White << this->endBreak;

    if(BG256__174.str() == "\033[48;5;174m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 175
void Test_BGColours256::TEST_BG256_175() {
    std::ostringstream BG256__175;

    BG256__175 << termstylist::BG256_175;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_175 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;175m " << termstylist::FG_White << this->endBreak;

    if(BG256__175.str() == "\033[48;5;175m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 176
void Test_BGColours256::TEST_BG256_176() {
    std::ostringstream BG256__176;

    BG256__176 << termstylist::BG256_176;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_176 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;176m " << termstylist::FG_White << this->endBreak;

    if(BG256__176.str() == "\033[48;5;176m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 177
void Test_BGColours256::TEST_BG256_177() {
    std::ostringstream BG256__177;

    BG256__177 << termstylist::BG256_177;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_177 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;177m " << termstylist::FG_White << this->endBreak;

    if(BG256__177.str() == "\033[48;5;177m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 178
void Test_BGColours256::TEST_BG256_178() {
    std::ostringstream BG256__178;

    BG256__178 << termstylist::BG256_178;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_178 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;178m " << termstylist::FG_White << this->endBreak;

    if(BG256__178.str() == "\033[48;5;178m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 179
void Test_BGColours256::TEST_BG256_179() {
    std::ostringstream BG256__179;

    BG256__179 << termstylist::BG256_179;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_179 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;179m " << termstylist::FG_White << this->endBreak;

    if(BG256__179.str() == "\033[48;5;179m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 180
void Test_BGColours256::TEST_BG256_180() {
    std::ostringstream BG256__180;

    BG256__180 << termstylist::BG256_180;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_180 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;180m " << termstylist::FG_White << this->endBreak;

    if(BG256__180.str() == "\033[48;5;180m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 181
void Test_BGColours256::TEST_BG256_181() {
    std::ostringstream BG256__181;

    BG256__181 << termstylist::BG256_181;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_181 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;181m " << termstylist::FG_White << this->endBreak;

    if(BG256__181.str() == "\033[48;5;181m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 182
void Test_BGColours256::TEST_BG256_182() {
    std::ostringstream BG256__182;

    BG256__182 << termstylist::BG256_182;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_182 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;182m " << termstylist::FG_White << this->endBreak;

    if(BG256__182.str() == "\033[48;5;182m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 183
void Test_BGColours256::TEST_BG256_183() {
    std::ostringstream BG256__183;

    BG256__183 << termstylist::BG256_183;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_183 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;183m " << termstylist::FG_White << this->endBreak;

    if(BG256__183.str() == "\033[48;5;183m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 184
void Test_BGColours256::TEST_BG256_184() {
    std::ostringstream BG256__184;

    BG256__184 << termstylist::BG256_184;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_184 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;184m " << termstylist::FG_White << this->endBreak;
    
    if(BG256__184.str() == "\033[48;5;184m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 185
void Test_BGColours256::TEST_BG256_185() {
    std::ostringstream BG256__185;

    BG256__185 << termstylist::BG256_185;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_185 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;185m " << termstylist::FG_White << this->endBreak;

    if(BG256__185.str() == "\033[48;5;185m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 186
void Test_BGColours256::TEST_BG256_186() {
    std::ostringstream BG256__186;

    BG256__186 << termstylist::BG256_186;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_186 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;186m " << termstylist::FG_White << this->endBreak;

    if(BG256__186.str() == "\033[48;5;186m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 187
void Test_BGColours256::TEST_BG256_187() {
    std::ostringstream BG256__187;

    BG256__187 << termstylist::BG256_187;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_187 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;187m " << termstylist::FG_White << this->endBreak;

    if(BG256__187.str() == "\033[48;5;187m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 188
void Test_BGColours256::TEST_BG256_188() {
    std::ostringstream BG256__188;

    BG256__188 << termstylist::BG256_188;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_188 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;188m " << termstylist::FG_White << this->endBreak;

    if(BG256__188.str() == "\033[48;5;188m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 189
void Test_BGColours256::TEST_BG256_189() {
    std::ostringstream BG256__189;

    BG256__189 << termstylist::BG256_189;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_189 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;189m " << termstylist::FG_White << this->endBreak;

    if(BG256__189.str() == "\033[48;5;189m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 190
void Test_BGColours256::TEST_BG256_190() {
    std::ostringstream BG256__190;

    BG256__190 << termstylist::BG256_190;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_190 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;190m " << termstylist::FG_White << this->endBreak;

    if(BG256__190.str() == "\033[48;5;190m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 191
void Test_BGColours256::TEST_BG256_191() {
    std::ostringstream BG256__191;

    BG256__191 << termstylist::BG256_191;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_191 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;191m " << termstylist::FG_White << this->endBreak;

    if(BG256__191.str() == "\033[48;5;191m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 192
void Test_BGColours256::TEST_BG256_192() {
    std::ostringstream BG256__192;

    BG256__192 << termstylist::BG256_192;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_192 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;192m " << termstylist::FG_White << this->endBreak;

    if(BG256__192.str() == "\033[48;5;192m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 193
void Test_BGColours256::TEST_BG256_193() {
    std::ostringstream BG256__193;

    BG256__193 << termstylist::BG256_193;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_193 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;193m " << termstylist::FG_White << this->endBreak;

    if(BG256__193.str() == "\033[48;5;193m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 194
void Test_BGColours256::TEST_BG256_194() {
    std::ostringstream BG256__194;

    BG256__194 << termstylist::BG256_194;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_194 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;194m " << termstylist::FG_White << this->endBreak;

    if(BG256__194.str() == "\033[48;5;194m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 195
void Test_BGColours256::TEST_BG256_195() {
    std::ostringstream BG256__195;

    BG256__195 << termstylist::BG256_195;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_195 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;195m " << termstylist::FG_White << this->endBreak;

    if(BG256__195.str() == "\033[48;5;195m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 196
void Test_BGColours256::TEST_BG256_196() {
    std::ostringstream BG256__196;

    BG256__196 << termstylist::BG256_196;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_196 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;196m " << termstylist::FG_White << this->endBreak;

    if(BG256__196.str() == "\033[48;5;196m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 197
void Test_BGColours256::TEST_BG256_197() {
    std::ostringstream BG256__197;

    BG256__197 << termstylist::BG256_197;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_197 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;197m " << termstylist::FG_White << this->endBreak;

    if(BG256__197.str() == "\033[48;5;197m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 198
void Test_BGColours256::TEST_BG256_198() {
    std::ostringstream BG256__198;

    BG256__198 << termstylist::BG256_198;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_198 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;198m " << termstylist::FG_White << this->endBreak;

    if(BG256__198.str() == "\033[48;5;198m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 199
void Test_BGColours256::TEST_BG256_199() {
    std::ostringstream BG256__199;

    BG256__199 << termstylist::BG256_199;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_199 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;199m " << termstylist::FG_White << this->endBreak;

    if(BG256__199.str() == "\033[48;5;199m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 200
void Test_BGColours256::TEST_BG256_200() {
    std::ostringstream BG256__200;

    BG256__200 << termstylist::BG256_200;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_200 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;200m " << termstylist::FG_White << this->endBreak;

    if(BG256__200.str() == "\033[48;5;200m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 201
void Test_BGColours256::TEST_BG256_201() {
    std::ostringstream BG256__201;

    BG256__201 << termstylist::BG256_201;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_201 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;201m " << termstylist::FG_White << this->endBreak;

    if(BG256__201.str() == "\033[48;5;201m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 202
void Test_BGColours256::TEST_BG256_202() {
    std::ostringstream BG256__202;

    BG256__202 << termstylist::BG256_202;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_202 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;202m " << termstylist::FG_White << this->endBreak;

    if(BG256__202.str() == "\033[48;5;202m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 203
void Test_BGColours256::TEST_BG256_203() {
    std::ostringstream BG256__203;
    
    BG256__203 << termstylist::BG256_203;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_203 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;203m " << termstylist::FG_White << this->endBreak;

    if(BG256__203.str() == "\033[48;5;203m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 204
void Test_BGColours256::TEST_BG256_204() {
    std::ostringstream BG256__204;

    BG256__204 << termstylist::BG256_204;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_204 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;204m " << termstylist::FG_White << this->endBreak;

    if(BG256__204.str() == "\033[48;5;204m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 205
void Test_BGColours256::TEST_BG256_205() {
    std::ostringstream BG256__205;

    BG256__205 << termstylist::BG256_205;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_205 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;205m " << termstylist::FG_White << this->endBreak;

    if(BG256__205.str() == "\033[48;5;205m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 206
void Test_BGColours256::TEST_BG256_206() {
    std::ostringstream BG256__206;

    BG256__206 << termstylist::BG256_206;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_206 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;206m " << termstylist::FG_White << this->endBreak;

    if(BG256__206.str() == "\033[48;5;206m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 207
void Test_BGColours256::TEST_BG256_207() {
    std::ostringstream BG256__207;

    BG256__207 << termstylist::BG256_207;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_207 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;207m " << termstylist::FG_White << this->endBreak;

    if(BG256__207.str() == "\033[48;5;207m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 208
void Test_BGColours256::TEST_BG256_208() {
    std::ostringstream BG256__208;

    BG256__208 << termstylist::BG256_208;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_208 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;208m " << termstylist::FG_White << this->endBreak;

    if(BG256__208.str() == "\033[48;5;208m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 209
void Test_BGColours256::TEST_BG256_209() {
    std::ostringstream BG256__209;
    
    BG256__209 << termstylist::BG256_209;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_209 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;209m " << termstylist::FG_White << this->endBreak;

    if(BG256__209.str() == "\033[48;5;209m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 210
void Test_BGColours256::TEST_BG256_210() {
    std::ostringstream BG256__210;

    BG256__210 << termstylist::BG256_210;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_210 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;210m " << termstylist::FG_White << this->endBreak;

    if(BG256__210.str() == "\033[48;5;210m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 211
void Test_BGColours256::TEST_BG256_211() {
    std::ostringstream BG256__211;

    BG256__211 << termstylist::BG256_211;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_211 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;211m " << termstylist::FG_White << this->endBreak;

    if(BG256__211.str() == "\033[48;5;211m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 212
void Test_BGColours256::TEST_BG256_212() {
    std::ostringstream BG256__212;

    BG256__212 << termstylist::BG256_212;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_212 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;212m " << termstylist::FG_White << this->endBreak;

    if(BG256__212.str() == "\033[48;5;212m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 213
void Test_BGColours256::TEST_BG256_213() {
    std::ostringstream BG256__213;

    BG256__213 << termstylist::BG256_213;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_213 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;213m " << termstylist::FG_White << this->endBreak;

    if(BG256__213.str() == "\033[48;5;213m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 214
void Test_BGColours256::TEST_BG256_214() {
    std::ostringstream BG256__214;

    BG256__214 << termstylist::BG256_214;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_214 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;214m " << termstylist::FG_White << this->endBreak;

    if(BG256__214.str() == "\033[48;5;214m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 215
void Test_BGColours256::TEST_BG256_215() {
    std::ostringstream BG256__215;

    BG256__215 << termstylist::BG256_215;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_215 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;215m " << termstylist::FG_White << this->endBreak;

    if(BG256__215.str() == "\033[48;5;215m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 216
void Test_BGColours256::TEST_BG256_216() {
    std::ostringstream BG256__216;

    BG256__216 << termstylist::BG256_216;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_216 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;216m " << termstylist::FG_White << this->endBreak;

    if(BG256__216.str() == "\033[48;5;216m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 217
void Test_BGColours256::TEST_BG256_217() {
    std::ostringstream BG256__217;

    BG256__217 << termstylist::BG256_217;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_217 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;217m " << termstylist::FG_White << this->endBreak;

    if(BG256__217.str() == "\033[48;5;217m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 218
void Test_BGColours256::TEST_BG256_218() {
    std::ostringstream BG256__218;

    BG256__218 << termstylist::BG256_218;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_218 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;218m " << termstylist::FG_White << this->endBreak;

    if(BG256__218.str() == "\033[48;5;218m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 219
void Test_BGColours256::TEST_BG256_219() {
    std::ostringstream BG256__219;

    BG256__219 << termstylist::BG256_219;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_219 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;219m " << termstylist::FG_White << this->endBreak;

    if(BG256__219.str() == "\033[48;5;219m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 220
void Test_BGColours256::TEST_BG256_220() {
    std::ostringstream BG256__220;

    BG256__220 << termstylist::BG256_220;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_220 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;220m " << termstylist::FG_White << this->endBreak;

    if(BG256__220.str() == "\033[48;5;220m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 221
void Test_BGColours256::TEST_BG256_221() {
    std::ostringstream BG256__221;

    BG256__221 << termstylist::BG256_221;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_221 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;221m " << termstylist::FG_White << this->endBreak;

    if(BG256__221.str() == "\033[48;5;221m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 222
void Test_BGColours256::TEST_BG256_222() {
    std::ostringstream BG256__222;

    BG256__222 << termstylist::BG256_222;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_222 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;222m " << termstylist::FG_White << this->endBreak;

    if(BG256__222.str() == "\033[48;5;222m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 223
void Test_BGColours256::TEST_BG256_223() {
    std::ostringstream BG256__223;

    BG256__223 << termstylist::BG256_223;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_223 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;223m " << termstylist::FG_White << this->endBreak;

    if(BG256__223.str() == "\033[48;5;223m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 224
void Test_BGColours256::TEST_BG256_224() {
    std::ostringstream BG256__224;

    BG256__224 << termstylist::BG256_224;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_224 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;224m " << termstylist::FG_White << this->endBreak;

    if(BG256__224.str() == "\033[48;5;224m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 225
void Test_BGColours256::TEST_BG256_225() {
    std::ostringstream BG256__225;

    BG256__225 << termstylist::BG256_225;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_225 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;225m " << termstylist::FG_White << this->endBreak;

    if(BG256__225.str() == "\033[48;5;225m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 226
void Test_BGColours256::TEST_BG256_226() {
    std::ostringstream BG256__226;

    BG256__226 << termstylist::BG256_226;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_226 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;226m " << termstylist::FG_White << this->endBreak;

    if(BG256__226.str() == "\033[48;5;226m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 227
void Test_BGColours256::TEST_BG256_227() {
    std::ostringstream BG256__227;

    BG256__227 << termstylist::BG256_227;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_227 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;227m " << termstylist::FG_White << this->endBreak;

    if(BG256__227.str() == "\033[48;5;227m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 228
void Test_BGColours256::TEST_BG256_228() {
    std::ostringstream BG256__228;

    BG256__228 << termstylist::BG256_228;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_228 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;228m " << termstylist::FG_White << this->endBreak;

    if(BG256__228.str() == "\033[48;5;228m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 229
void Test_BGColours256::TEST_BG256_229() {
    std::ostringstream BG256__229;

    BG256__229 << termstylist::BG256_229;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_229 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;229m " << termstylist::FG_White << this->endBreak;

    if(BG256__229.str() == "\033[48;5;229m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 230
void Test_BGColours256::TEST_BG256_230() {
    std::ostringstream BG256__230;

    BG256__230 << termstylist::BG256_230;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_230 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;230m " << termstylist::FG_White << this->endBreak;

    if(BG256__230.str() == "\033[48;5;230m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 231
void Test_BGColours256::TEST_BG256_231() {
    std::ostringstream BG256__231;

    BG256__231 << termstylist::BG256_231;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_231 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;231m " << termstylist::FG_White << this->endBreak;

    if(BG256__231.str() == "\033[48;5;231m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 232
void Test_BGColours256::TEST_BG256_232() {
    std::ostringstream BG256__232;

    BG256__232 << termstylist::BG256_232;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_232 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;232m " << termstylist::FG_White << this->endBreak;

    if(BG256__232.str() == "\033[48;5;232m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 233
void Test_BGColours256::TEST_BG256_233() {
    std::ostringstream BG256__233;

    BG256__233 << termstylist::BG256_233;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_233 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;233m " << termstylist::FG_White << this->endBreak;

    if(BG256__233.str() == "\033[48;5;233m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 234
void Test_BGColours256::TEST_BG256_234() {
    std::ostringstream BG256__234;

    BG256__234 << termstylist::BG256_234;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_234 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;234m " << termstylist::FG_White << this->endBreak;

    if(BG256__234.str() == "\033[48;5;234m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 235
void Test_BGColours256::TEST_BG256_235() {
    std::ostringstream BG256__235;

    BG256__235 << termstylist::BG256_235;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_235 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;235m " << termstylist::FG_White << this->endBreak;

    if(BG256__235.str() == "\033[48;5;235m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 236
void Test_BGColours256::TEST_BG256_236() {
    std::ostringstream BG256__236;

    BG256__236 << termstylist::BG256_236;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_236 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;236m " << termstylist::FG_White << this->endBreak;

    if(BG256__236.str() == "\033[48;5;236m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 237
void Test_BGColours256::TEST_BG256_237() {
    std::ostringstream BG256__237;

    BG256__237 << termstylist::BG256_237;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_237 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[38;5;237m " << termstylist::FG_White << this->endBreak;

    if(BG256__237.str() == "\033[48;5;237m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 238
void Test_BGColours256::TEST_BG256_238() {
    std::ostringstream BG256__238;

    BG256__238 << termstylist::BG256_238;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_238 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;238m " << termstylist::FG_White << this->endBreak;

    if(BG256__238.str() == "\033[48;5;238m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 239
void Test_BGColours256::TEST_BG256_239() {
    std::ostringstream BG256__239;

    BG256__239 << termstylist::BG256_239;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_239 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;239m " << termstylist::FG_White << this->endBreak;

    if(BG256__239.str() == "\033[48;5;239m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 240
void Test_BGColours256::TEST_BG256_240() {
    std::ostringstream BG256__240;

    BG256__240 << termstylist::BG256_240;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_240 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;240m " << termstylist::FG_White << this->endBreak;

    if(BG256__240.str() == "\033[48;5;240m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 241
void Test_BGColours256::TEST_BG256_241() {
    std::ostringstream BG256__241;

    BG256__241 << termstylist::BG256_241;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_241 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;241m " << termstylist::FG_White << this->endBreak;

    if(BG256__241.str() == "\033[48;5;241m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 242
void Test_BGColours256::TEST_BG256_242() {
    std::ostringstream BG256__242;

    BG256__242 << termstylist::BG256_242;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_242 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;242m " << termstylist::FG_White << this->endBreak;

    if(BG256__242.str() == "\033[48;5;242m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 243
void Test_BGColours256::TEST_BG256_243() {
    std::ostringstream BG256__243;

    BG256__243 << termstylist::BG256_243;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_243 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;243m " << termstylist::FG_White << this->endBreak;

    if(BG256__243.str() == "\033[48;5;243m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 244
void Test_BGColours256::TEST_BG256_244() {
    std::ostringstream BG256__244;

    BG256__244 << termstylist::BG256_244;
    
    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_244 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;244m " << termstylist::FG_White << this->endBreak;

    if(BG256__244.str() == "\033[48;5;244m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 245
void Test_BGColours256::TEST_BG256_245() {
    std::ostringstream BG256__245;

    BG256__245 << termstylist::BG256_245;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_245 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;245m " << termstylist::FG_White << this->endBreak;

    if(BG256__245.str() == "\033[48;5;245m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 246
void Test_BGColours256::TEST_BG256_246() {
    std::ostringstream BG256__246;

    BG256__246 << termstylist::BG256_246;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_246 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;246m " << termstylist::FG_White << this->endBreak;

    if(BG256__246.str() == "\033[48;5;246m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 247
void Test_BGColours256::TEST_BG256_247() {
    std::ostringstream BG256__247;

    BG256__247 << termstylist::BG256_247;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_247 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;247m " << termstylist::FG_White << this->endBreak;

    if(BG256__247.str() == "\033[48;5;247m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 248
void Test_BGColours256::TEST_BG256_248() {
    std::ostringstream BG256__248;

    BG256__248 << termstylist::BG256_248;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_248 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;248m " << termstylist::FG_White << this->endBreak;

    if(BG256__248.str() == "\033[48;5;248m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 249
void Test_BGColours256::TEST_BG256_249() {
    std::ostringstream BG256__249;

    BG256__249 << termstylist::BG256_249;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_249 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;249m " << termstylist::FG_White << this->endBreak;
    
    if(BG256__249.str() == "\033[48;5;249m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 250
void Test_BGColours256::TEST_BG256_250() {
    std::ostringstream BG256__250;

    BG256__250 << termstylist::BG256_250;
    
    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_250 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;250m " << termstylist::FG_White << this->endBreak;

    if(BG256__250.str() == "\033[48;5;250m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 251
void Test_BGColours256::TEST_BG256_251() {
    std::ostringstream BG256__251;

    BG256__251 << termstylist::BG256_251;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_251 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;251m " << termstylist::FG_White << this->endBreak;

    if(BG256__251.str() == "\033[48;5;251m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 252
void Test_BGColours256::TEST_BG256_252() {
    std::ostringstream BG256__252;

    BG256__252 << termstylist::BG256_252;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_252 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;252m " << termstylist::FG_White << this->endBreak;

    if(BG256__252.str() == "\033[48;5;252m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 253
void Test_BGColours256::TEST_BG256_253() {
    std::ostringstream BG256__253;

    BG256__253 << termstylist::BG256_253;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_253 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;253m " << termstylist::FG_White << this->endBreak;

    if(BG256__253.str() == "\033[48;5;253m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 254
void Test_BGColours256::TEST_BG256_254() {
    std::ostringstream BG256__254;

    BG256__254 << termstylist::BG256_254;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_254 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;254m " << termstylist::FG_White << this->endBreak;

    if(BG256__254.str() == "\033[48;5;254m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 255
void Test_BGColours256::TEST_BG256_255() {
    std::ostringstream BG256__255;

    BG256__255 << termstylist::BG256_255;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_255 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;255m " << termstylist::FG_White << this->endBreak;

    if(BG256__255.str() == "\033[48;5;255m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
//test: bg256 256
void Test_BGColours256::TEST_BG256_256() {
    std::ostringstream BG256__256;

    BG256__256 << termstylist::BG256_256;

    std::cout << termstylist::FG_LightYellow << "termstylist::BG256_256 " << termstylist::FG_White << this->shouldEqual << termstylist::FG_LightYellow << "\\033[48;5;256m " << termstylist::FG_White << this->endBreak;

    if(BG256__256.str() == "\033[48;5;256m") {
        std::cout << TEST_SUCCESS;
        countSuccess++;
    } else {
        std::cerr << TEST_FAILURE;
...
int main() {
    ...
    T_BGC_816.TEST_BG_BOLDLIGHTGREY();
    ...
    T_BGC_256.TEST_BG256_51();
    T_BGC_256.TEST_BG256_52();
    T_BGC_256.TEST_BG256_53();
    T_BGC_256.TEST_BG256_54();
    T_BGC_256.TEST_BG256_55();
    T_BGC_256.TEST_BG256_56();
    T_BGC_256.TEST_BG256_57();
    T_BGC_256.TEST_BG256_58();
    T_BGC_256.TEST_BG256_59();
    T_BGC_256.TEST_BG256_60();
    T_BGC_256.TEST_BG256_61();
    T_BGC_256.TEST_BG256_62();
    T_BGC_256.TEST_BG256_63();
    T_BGC_256.TEST_BG256_64();
    T_BGC_256.TEST_BG256_65();
    T_BGC_256.TEST_BG256_66();
    T_BGC_256.TEST_BG256_67();
    T_BGC_256.TEST_BG256_68();
    T_BGC_256.TEST_BG256_69();
    T_BGC_256.TEST_BG256_70();
    T_BGC_256.TEST_BG256_71();
    T_BGC_256.TEST_BG256_72();
    T_BGC_256.TEST_BG256_73();
    T_BGC_256.TEST_BG256_74();
    T_BGC_256.TEST_BG256_75();
    T_BGC_256.TEST_BG256_76();
    T_BGC_256.TEST_BG256_77();
    T_BGC_256.TEST_BG256_78();
    T_BGC_256.TEST_BG256_79();
    T_BGC_256.TEST_BG256_80();
    T_BGC_256.TEST_BG256_81();
    T_BGC_256.TEST_BG256_82();
    T_BGC_256.TEST_BG256_83();
    T_BGC_256.TEST_BG256_84();
    T_BGC_256.TEST_BG256_85();
    T_BGC_256.TEST_BG256_86();
    T_BGC_256.TEST_BG256_87();
    T_BGC_256.TEST_BG256_88();
    T_BGC_256.TEST_BG256_89();
    T_BGC_256.TEST_BG256_90();
    T_BGC_256.TEST_BG256_91();
    T_BGC_256.TEST_BG256_92();
    T_BGC_256.TEST_BG256_93();
    T_BGC_256.TEST_BG256_94();
    T_BGC_256.TEST_BG256_95();
    T_BGC_256.TEST_BG256_96();
    T_BGC_256.TEST_BG256_97();
    ...
    T_BGC_256.TEST_BG256_111();
    T_BGC_256.TEST_BG256_112();
    T_BGC_256.TEST_BG256_113();
    T_BGC_256.TEST_BG256_114();
    T_BGC_256.TEST_BG256_115();
    T_BGC_256.TEST_BG256_116();
    T_BGC_256.TEST_BG256_117();
    T_BGC_256.TEST_BG256_118();
    T_BGC_256.TEST_BG256_119();
    T_BGC_256.TEST_BG256_120();
    T_BGC_256.TEST_BG256_121();
    T_BGC_256.TEST_BG256_122();
    T_BGC_256.TEST_BG256_123();
    T_BGC_256.TEST_BG256_124();
    T_BGC_256.TEST_BG256_125();
    T_BGC_256.TEST_BG256_126();
    T_BGC_256.TEST_BG256_127();
    T_BGC_256.TEST_BG256_128();
    T_BGC_256.TEST_BG256_129();
    T_BGC_256.TEST_BG256_130();
    T_BGC_256.TEST_BG256_131();
    T_BGC_256.TEST_BG256_132();
    T_BGC_256.TEST_BG256_133();
    T_BGC_256.TEST_BG256_134();
    T_BGC_256.TEST_BG256_135();
    T_BGC_256.TEST_BG256_136();
    T_BGC_256.TEST_BG256_137();
    T_BGC_256.TEST_BG256_138();
    T_BGC_256.TEST_BG256_139();
    T_BGC_256.TEST_BG256_140();
    T_BGC_256.TEST_BG256_141();
    T_BGC_256.TEST_BG256_142();
    T_BGC_256.TEST_BG256_143();
    T_BGC_256.TEST_BG256_144();
    T_BGC_256.TEST_BG256_145();
    T_BGC_256.TEST_BG256_146();
    T_BGC_256.TEST_BG256_147();
    T_BGC_256.TEST_BG256_148();
    T_BGC_256.TEST_BG256_149();
    T_BGC_256.TEST_BG256_150();
    T_BGC_256.TEST_BG256_151();
    T_BGC_256.TEST_BG256_152();
    T_BGC_256.TEST_BG256_153();
    T_BGC_256.TEST_BG256_154();
    T_BGC_256.TEST_BG256_155();
    T_BGC_256.TEST_BG256_156();
    T_BGC_256.TEST_BG256_157();
    T_BGC_256.TEST_BG256_158();
    T_BGC_256.TEST_BG256_159();
    T_BGC_256.TEST_BG256_160();
    T_BGC_256.TEST_BG256_161();
    T_BGC_256.TEST_BG256_162();
    T_BGC_256.TEST_BG256_163();
    T_BGC_256.TEST_BG256_164();
    T_BGC_256.TEST_BG256_165();
    T_BGC_256.TEST_BG256_166();
    T_BGC_256.TEST_BG256_167();
    T_BGC_256.TEST_BG256_168();
    T_BGC_256.TEST_BG256_169();
    T_BGC_256.TEST_BG256_170();
    T_BGC_256.TEST_BG256_171();
    T_BGC_256.TEST_BG256_172();
    T_BGC_256.TEST_BG256_173();
    T_BGC_256.TEST_BG256_174();
    T_BGC_256.TEST_BG256_175();
    T_BGC_256.TEST_BG256_176();
    T_BGC_256.TEST_BG256_177();
    T_BGC_256.TEST_BG256_178();
    T_BGC_256.TEST_BG256_179();
    T_BGC_256.TEST_BG256_180();
    T_BGC_256.TEST_BG256_181();
    T_BGC_256.TEST_BG256_182();
    T_BGC_256.TEST_BG256_183();
    T_BGC_256.TEST_BG256_184();
    T_BGC_256.TEST_BG256_185();
    T_BGC_256.TEST_BG256_186();
    T_BGC_256.TEST_BG256_187();
    T_BGC_256.TEST_BG256_188();
    T_BGC_256.TEST_BG256_189();
    T_BGC_256.TEST_BG256_190();
    T_BGC_256.TEST_BG256_191();
    T_BGC_256.TEST_BG256_192();
    T_BGC_256.TEST_BG256_193();
    T_BGC_256.TEST_BG256_194();
    T_BGC_256.TEST_BG256_195();
    T_BGC_256.TEST_BG256_196();
    T_BGC_256.TEST_BG256_197();
    T_BGC_256.TEST_BG256_198();
    T_BGC_256.TEST_BG256_199();
    T_BGC_256.TEST_BG256_200();
    T_BGC_256.TEST_BG256_201();
    T_BGC_256.TEST_BG256_202();
    T_BGC_256.TEST_BG256_203();
    T_BGC_256.TEST_BG256_204();
    T_BGC_256.TEST_BG256_205();
    T_BGC_256.TEST_BG256_206();
    T_BGC_256.TEST_BG256_207();
    T_BGC_256.TEST_BG256_208();
    T_BGC_256.TEST_BG256_209();
    T_BGC_256.TEST_BG256_210();
    T_BGC_256.TEST_BG256_211();
    T_BGC_256.TEST_BG256_212();
    T_BGC_256.TEST_BG256_213();
    T_BGC_256.TEST_BG256_214();
    T_BGC_256.TEST_BG256_215();
    T_BGC_256.TEST_BG256_216();
    T_BGC_256.TEST_BG256_217();
    T_BGC_256.TEST_BG256_218();
    T_BGC_256.TEST_BG256_219();
    T_BGC_256.TEST_BG256_220();
    T_BGC_256.TEST_BG256_221();
    T_BGC_256.TEST_BG256_222();
    T_BGC_256.TEST_BG256_223();
    T_BGC_256.TEST_BG256_224();
    T_BGC_256.TEST_BG256_225();
    T_BGC_256.TEST_BG256_226();
    T_BGC_256.TEST_BG256_227();
    T_BGC_256.TEST_BG256_228();
    T_BGC_256.TEST_BG256_229();
    T_BGC_256.TEST_BG256_230();
    T_BGC_256.TEST_BG256_231();
    T_BGC_256.TEST_BG256_232();
    T_BGC_256.TEST_BG256_233();
    T_BGC_256.TEST_BG256_234();
    T_BGC_256.TEST_BG256_235();
    T_BGC_256.TEST_BG256_236();
    T_BGC_256.TEST_BG256_237();
    T_BGC_256.TEST_BG256_238();
    T_BGC_256.TEST_BG256_239();
    T_BGC_256.TEST_BG256_240();
    T_BGC_256.TEST_BG256_241();
    T_BGC_256.TEST_BG256_242();
    T_BGC_256.TEST_BG256_243();
    T_BGC_256.TEST_BG256_244();
    T_BGC_256.TEST_BG256_245();
    T_BGC_256.TEST_BG256_246();
    T_BGC_256.TEST_BG256_247();
    T_BGC_256.TEST_BG256_248();
    T_BGC_256.TEST_BG256_249();
    T_BGC_256.TEST_BG256_250();
    T_BGC_256.TEST_BG256_251();
    T_BGC_256.TEST_BG256_252();
    T_BGC_256.TEST_BG256_253();
    T_BGC_256.TEST_BG256_254();
    T_BGC_256.TEST_BG256_255();
    T_BGC_256.TEST_BG256_256();
